...
public class Question {
	 ...
	 * @param args
	 */
	//Great demo provided by solution, so the conclusion is
	//Case1: same instance, same synced methods, executed sequentially
	//Case2: different instance, same synced method but not static, executed separately
	//Case3: different instance, different methods but not static, executed separately
